...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['numero1']) && isset($_POST['numero2']) && isset($_POST['numero3'])) {
    ...
    $array = [$_POST['numero1'], $_POST['numero2'], $_POST['numero3']];
    $resultado = "<p>El NÚMERO de la SUMATORIA del ARRAY es: " . sumatoria_a($array) . "</p>";
    $resultado = "<p>El NÚMERO de la SUMATORIA del ARRAY es: " . sumatoria_b($array) . "</p>";
    $resultado = "<p>El NÚMERO de la SUMATORIA del ARRAY es: " . sumatoria_c($array) . "</p>";
}
?>
...
<body>
    ...
    <div class="content">
        <h1 class="text-center pt-5 text-white fw-bold">Programacion Web II - UNLaM - Agustín Elián D'Angelo</h1>

        <h3 class="text-center mt-5 text-white fw-bold">Ejercicio 5 | Sumatoria</h3>
        ...
        <h4 class="text-center mt-5 text-white fw-bold">INGRESE los NÚMEROS del ARRAY a SUMAR</h4>
        ...
        <form action="" method="post" class="d-flex flex-column align-items-center">
            ...
            <div class="d-flex align-items-center mt-4">
                <label for="numero3" class="text-white fw-bold me-2">Número 3: </label>
